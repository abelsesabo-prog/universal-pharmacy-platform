...
export const PRODUCT_SCHEMA = Object.freeze({ required: ["tenantId", "brandName", "genericName", "dosageForm", "category"], optional: ["strength", "strengthUnit", "manufacturer", "registrationAgency", "registrationNumber", "packSize", "baseUnit", "uomMatrix", "barcode", "identityKey", "stockQuantity", "catalogInstalled", "catalogSource", "catalogFamilyId", "catalogRxcui"] });
export const BATCH_SCHEMA = Object.freeze({ required: ["tenantId", "productId", "batchNumber", "quantity", "expiryDate"], optional: ["manufacturedDate", "branchId", "costPrice", "sellingPrice", "location", "supplierId"] });
...
export const PURCHASE_ITEM_SCHEMA = Object.freeze({ required: ["tenantId", "productId", "batchId", "quantity", "baseQuantity", "uom", "conversionToBase", "unitCost", "lineTotal", "batchNumber", "expiryDate", "createdAt"], optional: ["manufacturedDate"] });
...
export const ACCOUNTING_PERIOD_SCHEMA = Object.freeze({ required: ["tenantId", "startsAt", "endsAt", "closed", "closedAt", "createdAt"], optional: ["closedBy", "note", "reconciliation", "updatedAt"] });
