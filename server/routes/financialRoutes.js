...
// Canonical double-entry ledger. Journal posting is manager/admin controlled and idempotent.
router.post("/finance/journals", requireRole("admin", "manager"), postJournalController);
